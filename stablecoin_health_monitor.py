...
#     ```bash
#     pip install streamlit pandas plotly requests python-dotenv joblib dune-client
#     ```
    
#     2. **Set Environment Variables:**
#     Create a `.env` file with:
#     ```
#     COINGECKO_PRO_API_KEY=your_coingecko_key_here
#     DEFI_JOSH_DUNE_QUERY_API_KEY=your_dune_key_here
#     ```
    
#     3. **Run the App:**
#     ```bash
#     streamlit run stablecoin_health_monitor.py
#     ```
    
#     4. **Data Directory Structure:**
#     ```
#     project/
#     ├── stablecoin_health_monitor.py
#     ├── .env
#     └── data/
#         ├── stablecoins_filtered.joblib (fallback)
#         ├── current_dominance_df.joblib (fallback)
#         └── stablecoins_historical_deviation.joblib (fallback)
#     ```
#     """)
